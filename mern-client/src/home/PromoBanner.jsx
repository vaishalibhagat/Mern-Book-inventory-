...
import bookPic from "../assets/awardbook.jpeg"
    ...
    <div className='mt-16 py-12 bg-teal-100 px-4 lg:px-24'>
      <div className='flex flex-col md:flex-row justify-between items-center gap-12'>
        <div className='md:w-1/2'>
            <h2 className='text-4xl font-bold mb-6 leading-snug'>2024 National Book Award  for Art Shortlist</h2>
        ...
        <div className='mt-6'>
            <img  src={bookPic} alt="" className='w-38' />
        </div>
      </div>
    </div>
  )
