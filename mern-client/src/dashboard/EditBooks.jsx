...
const EditBooks = () => {
  ...
  const {id} = useParams();
  const {author,image_url,category,book_description,book_title,book_pdf_url} = useLoaderData();
  ...
  const handleUpdate = (event) =>{
    ...
    const updatebookObj = {
      author,image_url,category,book_description,book_title,book_pdf_url
    }
  ...
  return (
    ...
    <div className='px-4 my-12'>
      ...
      <div className="mb-2 block">
        ...
        <TextInput id="author" type="text" placeholder="Auther Name" required defaultValue={author}/>
      ...
      <div className="flex gap-8">
       <div className='lg:w-1/2'>
        ...
        <TextInput id="image_url" type="text" placeholder="Book image URL" required defaultValue={image_url} />
      </div>
      ...
      <select className='w-full rounded' name="categoryName" id="category" value={selectedBookCategory}
      onChange={handleChangeSelectedValue}>
       ...
       <div>
        ...
        <Textarea className='w-full' id="book_description" type="text" placeholder="Write your Book Description..."  rows={4} defaultValue={book_description} />
      </div>
