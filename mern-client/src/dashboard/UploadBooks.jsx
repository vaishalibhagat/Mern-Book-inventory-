...
const UploadBooks = () => {
  ...
  fetch("http://localhost:2000/upload-book", {
    method: "POST",
    headers: {
  ...
  return (
    ...
    <div className='px-4 my-12'>
      ...
      <div className="mb-2 block">
        ...
        <TextInput id="author" type="text" placeholder="Auther Name" required />
      ...
      <div className="flex gap-8">
       <div className='lg:w-1/2'>
        ...
        <TextInput id="image_url" type="text" placeholder="Book image URL" required />
      </div>
      ...
      onChange={handleChangeSelectedValue}>
       ...
       <div>
        ...
        <Textarea className='w-full' id="book_description" type="text" placeholder="Write your Book Description..."  rows={4} />
      </div>
